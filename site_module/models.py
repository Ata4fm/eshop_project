...
class SiteSetting(models.Model):
    ...
    email = models.EmailField(max_length=200,null=True,blank=True, verbose_name='ایمیل سایت')
...
class SiteBanner(models.Model):
    ...
    positions = models.CharField(max_length=200,verbose_name='محل نمایش',choices=SiteBannerPositions.choices)
