    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('positions', models.CharField(choices=[('product_list', 'صفحه لیست محصولات'), ('product_detail', 'صفحه جزییات محصولات'), ('about_us', 'درباره ما')], max_length=200, verbose_name='محل نمایش')),
            ],
            options={
